...
class HotArtistBox extends React.Component {
	constructor(props) {
		super(props);
	...
	async componentDidMount() {
		const hotArtistBox = await fetchget("/api/top/artists?limit=50")
		this.setState({ hotArtistBoxs: hotArtistBox.artists })
	}

	render() {	
		const hotArtistBoxDetail = this.state.hotArtistBoxs;
			...
			<div className='artistCateCon'>
				...
				<div className='artistCateNav'>			
					<div className='suggest'>
						...
						<Router>
						<ul>
							<li><Link to='/hotartistbox' style={{color:"#c62f2f"}}>热门歌手</Link></li>
				...
				<div className='artistCateConBox'>
						...
						<div className='cateBoxTitle'>热门歌手</div>
