...
class KorGroup extends React.Component {
	constructor(props) {
		super(props);
	...
	async componentDidMount() {
		const korGroup = await fetchget("/api/artist/list?cat=7003")
		this.setState({ korGroups: korGroup.artists })
	}

	render() {
		const hotArtistBoxDetail = this.state.korGroups;
		return(<div className='artistCateList'>	
			<div className='artistCateCon'>
				...
				<div className='artistCateNav'>			
					...
					<div className='suggest'>
						...
						<ul>
							...
							<li><Link to='/korgroup' style={{color:"#c62f2f"}}>韩国组合/乐队</Link></li>
						</ul>
						</Router>
					</div>
					<div className='suggest'>
				...
				<div className='artistCateConBox'>
						...
						<div className='cateBoxTitle'>韩国组合/乐队</div>
