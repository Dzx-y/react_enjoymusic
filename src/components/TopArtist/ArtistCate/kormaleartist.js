...
class KorMaleArtist extends React.Component {
	constructor(props) {
		super(props);
	...
	async componentDidMount() {
		const korMaleArtist = await fetchget("/api/artist/list?cat=7001")
		this.setState({ korMaleArtists: korMaleArtist.artists })
	}

	render() {	
		const hotArtistBoxDetail = this.state.korMaleArtists;
			...
			<div className='artistCateCon'>
				...
				<div className='artistCateNav'>			
					...
					<div className='suggest'>
						...
						<Router>
						<ul>
							<li><Link to='/kormaleartist' style={{color:"#c62f2f"}}>韩国男歌手</Link></li>
				...
				<div className='artistCateConBox'>
						...
						<div className='cateBoxTitle'>韩国男歌手</div>
