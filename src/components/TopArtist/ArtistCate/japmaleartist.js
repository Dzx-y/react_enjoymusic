...
class JapMaleArtist extends React.Component {
	constructor(props) {
		super(props);
	...
	async componentDidMount() {
		const japMaleArtist = await fetchget("/api/artist/list?cat=6001")
		this.setState({ japMaleArtists: japMaleArtist.artists })
	}

	render() {
		const hotArtistBoxDetail = this.state.japMaleArtists;
			...
			<div className='artistCateCon'>
				...
				<div className='artistCateNav'>			
					...
					<div className='suggest'>
						...
						<Router>
						<ul>
							<li><Link to='/japmaleartist' style={{color:"#c62f2f"}}>日本男歌手</Link></li>
				...
				<div className='artistCateConBox'>
						...
						<div className='cateBoxTitle'>日本男歌手</div>
