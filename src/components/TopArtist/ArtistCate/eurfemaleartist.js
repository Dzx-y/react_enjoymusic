...
class EurFemaleArtist extends React.Component {
	constructor(props) {
		super(props);
	...
	async componentDidMount() {
		const eurFemaleArtist = await fetchget("/api/artist/list?cat=2002")
		this.setState({ eurFemaleArtists: eurFemaleArtist.artists })
	}

	render() {		
		const hotArtistBoxDetail = this.state.eurFemaleArtists;
		return(<div className='artistCateList'>	
			<div className='artistCateCon'>
				...
				<div className='artistCateNav'>			
					...
					<div className='suggest'>
						...
						<ul>
							...
							<li><Link to='/eurfemaleartist' style={{color:"#c62f2f"}}>欧美女歌手</Link></li>
				...
				<div className='artistCateConBox'>
						...
						<div className='cateBoxTitle'>欧美女歌手</div>
...
export default EurFemaleArtist;