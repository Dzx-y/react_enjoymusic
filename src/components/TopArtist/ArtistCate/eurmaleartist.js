...
class EurMaleArtist extends React.Component {
	constructor(props) {
		super(props);
	...
	async componentDidMount() {
		const eurMaleArtist = await fetchget("/api/artist/list?cat=2001")
		this.setState({ eurMaleArtists: eurMaleArtist.artists })
	}

	render() {	
		const hotArtistBoxDetail = this.state.eurMaleArtists;
			...
			<div className='artistCateCon'>
				...
				<div className='artistCateNav'>			
					...
					<div className='suggest'>
						...
						<Router>
						<ul>
							<li><Link to='/eurmaleartist' style={{color:"#c62f2f"}}>欧美男歌手</Link></li>
				...
				<div className='artistCateConBox'>
						...
						<div className='cateBoxTitle'>欧美男歌手</div>
