...
class CnMaleArtist extends React.Component {
	constructor(props) {
		super(props);
	...
	async componentDidMount() {
		const cnMaleArtist = await fetchget("/api/artist/list?cat=1001")
		this.setState({ cnMaleArtists: cnMaleArtist.artists })
	}

	render() {	
		const hotArtistBoxDetail = this.state.cnMaleArtists;
			...
			<div className='artistCateCon'>
				...
				<div className='artistCateNav'>			
					...
					<div className='suggest'>
						...
						<Router>
						<ul>
							<li><Link to='/cnmaleartist' style={{color:"#c62f2f"}}>华语男歌手</Link></li>
				...
				<div className='artistCateConBox'>
						...
						<div className='cateBoxTitle'>华语男歌手</div>
