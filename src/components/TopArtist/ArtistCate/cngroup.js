...
class CnGroup extends React.Component {
	constructor(props) {
		super(props);
	...
	async componentDidMount() {
		const cnGroup = await fetchget("/api/artist/list?cat=1003")
		this.setState({ cnGroups: cnGroup.artists })
	}

	render() {	
		const hotArtistBoxDetail = this.state.cnGroups;
		return(<div className='artistCateList'>	
			<div className='artistCateCon'>
				...
				<div className='artistCateNav'>			
					...
					<div className='suggest'>
						...
						<ul>
							...
							<li><Link to='/cngroup'  style={{color:"#c62f2f"}}>华语组合/乐队</Link></li>
						</ul>
						</Router>
					</div>
					<div className='suggest'>
				...
				<div className='artistCateConBox'>
						...
						<div className='cateBoxTitle'>华语组合/乐队</div>
