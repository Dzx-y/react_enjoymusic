...
class JapFemaleArtist extends React.Component {
	constructor(props) {
		super(props);
	...
	async componentDidMount() {
		const japFemaleArtist = await fetchget("/api/artist/list?cat=6002")
		this.setState({ japFemaleArtists: japFemaleArtist.artists })
	}

	render() {	
		const hotArtistBoxDetail = this.state.japFemaleArtists;
		return(<div className='artistCateList'>	
			<div className='artistCateCon'>
				...
				<div className='artistCateNav'>			
					...
					<div className='suggest'>
						...
						<ul>
							...
							<li><Link to='/japfemaleartist' style={{color:"#c62f2f"}}>日本女歌手</Link></li>
				...
				<div className='artistCateConBox'>
						...
						<div className='cateBoxTitle'>日本女歌手</div>
...
export default JapFemaleArtist;