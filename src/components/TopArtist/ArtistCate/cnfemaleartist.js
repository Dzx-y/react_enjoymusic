...
class CnFemaleArtist extends React.Component {
	constructor(props) {
		super(props);
	...
	async componentDidMount() {
		const cnFemaleArtist = await fetchget("/api/artist/list?cat=1002")
		this.setState({ cnFemaleArtists: cnFemaleArtist.artists })
	}

	render() {	
		const hotArtistBoxDetail = this.state.cnFemaleArtists;
		return(<div className='artistCateList'>	
			<div className='artistCateCon'>
				...
				<div className='artistCateNav'>			
					...
					<div className='suggest'>
						...
						<ul>
							...
							<li><Link to='/cnfemaleartist' style={{color:"#c62f2f"}}>华语女歌手</Link></li>
				...
				<div className='artistCateConBox'>
						...
						<div className='cateBoxTitle'>华语女歌手</div>
