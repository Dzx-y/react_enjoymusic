...
class EnterArtist extends React.Component {
	constructor(props) {
		super(props);
	...
	async componentDidMount() {
		const enterArtist = await fetchget("/api/artist/list?cat=5001")
		this.setState({ enterArtists: enterArtist.artists })
	}

	render() {	
		const hotArtistBoxDetail = this.state.enterArtists;
		return(<div className='artistCateList'>	
			<div className='artistCateCon'>
				...
				<div className='artistCateNav'>			
					<div className='suggest'>
						...
						<ul>
							...
							<li><Link to='/enterartist' style={{color:"#c62f2f"}}>入驻歌手</Link></li>
						</ul>
						</Router>
					</div>
					<div className='suggest'>
				...
				<div className='artistCateConBox'>
						...
						<div className='cateBoxTitle'>入驻歌手</div>
